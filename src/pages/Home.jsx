...
const PointerArrow = ({ number, delay }) => (
    <div className="absolute -top-14 left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce text-[#d13852] font-bold z-50 pointer-events-none" style={{animationDelay: delay}}>
        <span className="bg-white rounded-full w-6 h-6 flex items-center justify-center shadow-lg text-sm border-2 border-[#d13852]">
            {number}
        </span>
            ...
            <div id="wrapper">
                ...
                <div className="content">
                    <div className="left">
                        ...
                        <div className="btn flex md:gap-4 md:flex-row flex-col gap-12 mt-10 md:mt-0">
                            <button onClick={() => SetActive(!Active)} id="btn__letter" className="relative">
                                <PointerArrow number="1" delay="0s" />
                            ...
                            <div id="FromRonit" className="relative mt-2 md:mt-0">
                                <PointerArrow number="2" delay="0.2s" />
                ...
                <section className="smallLetter absolute md:-bottom-26 -bottom-40 md:left-[45%] left-[50%] -translate-x-1/2" style={{ "--t": "15.6s" }}>
                    <PointerArrow number="3" delay="0.4s" />
                    <SmallLetter />
                </section>
            </div>
        </>
