...
const LoveLetter = () => {
    ...
    return (
        <main className='munna bg-[#8b0000] h-screen w-full overflow-hidden'>
            <button 
                onClick={() => navigate(-1)}
                className="absolute top-6 left-6 z-50 bg-white/20 text-white px-4 py-2 rounded-full hover:bg-white/40 transition-all font-bold backdrop-blur-sm cursor-pointer border border-white/30"
            >
                ← Back
            </button>
                ...
                <div className={`envelope ${openEnvelope ? "active" : ""}`}>
                    ...
                    <div className="munna envelope-flap text-black relative">
                        <div className='munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2'>
                            ...
                            <span className='munna font-dancingScript md:text-3xl text-xl'>Dear Arpita</span>
                        </div>
                    </div>
